const poems = [
  {
    title: `Успокойся, дыши`,
    date: "14.08.26",
    text: `Льётся дым изо рта,
...
И такой долгожданный покой.`
  ...
  {
    title: `Буду ждать, пиши`,
    date: "14.08.26",
    text: `Зубы стали редкими, сны не удержать,
Рвут мои иллюзии, как умеют рвать,
Раны мои рваные, рвутся каждый день,
Снова сердце прячется как слепая тень.

Ночью трепыхается, ноет от любви,
Что-то в нём да копится, только не зови,
...
Тихо трогать ландыши, маков пить росу.

Но шатая жвалами, челюстью стуча,
Я горю кошмарами, плавясь как свеча,
Сколько раз во сне уже я сказал «прости»?
...
Снова хотел быть целым...`
  },
  {
    title: `Некому понять`,
    date: "05.07.26",
    text: `Где-то там вдали,
Улетают ровным строем журавли,
И навеки оторвавшись от земли,
Нам поют в один последний раз.
Все календари,
Сколько ты их не проси и не моли,
Растворятся как в тумане корабли,
Покидая все реальности без нас.

Где же мы теперь?
Среди всех этих лишений и потерь,
Я старался объясниться, но поверь,
Я устал всё это снова повторять.
Мой любимый зверь,
Я прошу тебя уймись, не лицемерь,
Мы одни остались, гонор поумерь,
Больше нас тут уже некому понять.`
  },
  {
    title: `На ночь глядя...`,
    date: "09.09.13",
...
Но он тоже придет... Постепенно.`
  },
  {
    title: `Запах цветов`,
    date: "04.04.26",
    text: `Пляшет ночью с облаками гроза,
